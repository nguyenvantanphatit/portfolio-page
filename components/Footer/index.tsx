        ...
        <>
            ...
            <div className="header h-60 md:h-[200px]">
                ...
                <div className="w-full max-w-7xl px-5 lg:px-8 mx-auto">
                    <div className="py-7">
                        <div className="flex items-center justify-center flex-col lg:space-y-0  lg:justify-around lg:flex-row">
                            <div className="flex justify-center space-x-4 sm:justify-center sm:mt-0 ">
                                <a href="#" className="w-9 h-9 rounded-full border border-black flex justify-center items-center hover:border-indigo-700">
                                ...
                                <a href="https://www.instagram.com/tannnphatttttttt/" className="w-9 h-9 rounded-full border border-black flex justify-center items-center hover:border-indigo-700">
                                    <svg className="w-5 h-5 text-white" viewBox="0 0 15 15" fill="blue" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="https://www.facebook.com/tanphat05062001" className="w-9 h-9 rounded-full border border-black flex justify-center items-center hover:border-indigo-700">
                                    <svg className="w-4 h-4 text-white" viewBox="0 0 13 12" fill="blue" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="" className="w-9 h-9 rounded-full border border-black flex justify-center items-center hover:border-indigo-700">
                                    <svg className="w-5 h-3.5 text-white" viewBox="0 0 16 12" fill="blue" xmlns="http://www.w3.org/2000/svg">
